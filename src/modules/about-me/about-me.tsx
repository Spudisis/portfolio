	...
	return (
		<div className={s.wrapper}>
			<div ref={ref} className={`${s.content} ${inView && s.animation}`}>
				...
				<p className={s.text}>{t("I have a bachelor's degree in space information systems and technologies from NNSTU. Currently, I continue to study new technologies and best practices to write better, more maintainable and readable code. Open for new various offers, both for full-time and project work in a friendly team :). Always in touch.")}</p>
			</div>
		</div>
	);
};
